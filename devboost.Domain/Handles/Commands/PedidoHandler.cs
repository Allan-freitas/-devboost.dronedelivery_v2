...
namespace devboost.Domain.Handles.Commands
{
    public class PedidoHandler : IPedidoHandler
    {
        ...
        public PedidoHandler(IPedidoRepository pedidoRepository, IDroneRepository droneRepository, IClienteQueryHandler clienteHandler)
        {
        ...
        {
            var cliente = await _clienteHandler.GetClienteByUserName(username);
